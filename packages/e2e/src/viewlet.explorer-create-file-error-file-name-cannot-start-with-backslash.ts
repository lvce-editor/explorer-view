...
export const name = 'viewlet.explorer-create-file-error-file-name-cannot-start-with-backslash'
...
export const test: Test = async ({ FileSystem, Workspace, Explorer, expect, Locator }) => {
  ...
  await expect(errorMessage).toHaveText('A file or folder name cannot start with a backslash.')
}
