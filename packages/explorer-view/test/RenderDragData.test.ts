...
test('renderDragData - focused and selected items when pointing at the focused item', () => {
  ...
  const newState: ExplorerState = {
    ...
    isPointerDown: true,
    items: [
      { depth: 1, name: 'a.txt', posInSet: 1, selected: true, setSize: 3, type: DirentType.File, uri: '/workspace/a.txt' },
      { depth: 1, name: 'b.txt', posInSet: 2, selected: false, setSize: 3, type: DirentType.File, uri: '/workspace/b.txt' },
      { depth: 1, name: 'c.txt', posInSet: 3, selected: true, setSize: 3, type: DirentType.File, uri: 'file:///workspace/c.txt' },
    ],
    pointerDownIndex: 1,
    uid: 123,
  }
...
test('renderDragData - focused and selected items when pointing at a selected item', () => {
  ...
  const newState: ExplorerState = {
    ...
    isPointerDown: true,
    items: [
      { depth: 1, name: 'a.txt', posInSet: 1, selected: false, setSize: 3, type: DirentType.File, uri: '/workspace/a.txt' },
      { depth: 1, name: 'b.txt', posInSet: 2, selected: true, setSize: 3, type: DirentType.File, uri: '/workspace/b.txt' },
      { depth: 1, name: 'c.txt', posInSet: 3, selected: true, setSize: 3, type: DirentType.File, uri: '/workspace/c.txt' },
    ],
    pointerDownIndex: 1,
    uid: 123,
  }
...
test('renderDragData - only pointed item when pointing outside the selection', () => {
  ...
  const newState: ExplorerState = {
    ...
    items: [
      { depth: 1, name: 'a.txt', posInSet: 1, selected: false, setSize: 3, type: DirentType.File, uri: '/workspace/a.txt' },
      { depth: 1, name: 'b.txt', posInSet: 2, selected: true, setSize: 3, type: DirentType.File, uri: '/workspace/b.txt' },
      { depth: 1, name: 'c.txt', posInSet: 3, selected: false, setSize: 3, type: DirentType.File, uri: '/workspace/c.txt' },
    ],
    pointerDownIndex: 2,
    uid: 123,
  }
    ...
    items: [
      {
        ...
        uri: 'remote-ssh://test-host/workspace/src',
      },
    ],
    pointerDownIndex: 0,
    uid: 123,
...
test('renderDragData - no item for an out-of-range pointer index', () => {
  ...
  const newState: ExplorerState = {
    ...
    focusedIndex: 0,
    isPointerDown: true,
    items: [{ depth: 1, name: 'a.txt', posInSet: 1, selected: false, setSize: 1, type: DirentType.File, uri: '/workspace/a.txt' }],
    pointerDownIndex: 99,
    uid: 123,
  }
